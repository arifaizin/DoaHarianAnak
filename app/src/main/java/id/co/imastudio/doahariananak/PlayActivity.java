...
public class PlayActivity extends AppCompatActivity {
    ...
    private int[] artidoa = {
            R.drawable.artidoa01,
            R.drawable.artidoa02,
            R.drawable.artidoa03,
            R.drawable.artidoa04,
            R.drawable.artidoa05,
            R.drawable.artidoa06,
            R.drawable.artidoa07,
            R.drawable.artidoa08,
            R.drawable.artidoa09,
            R.drawable.artidoa10
    };
...
//                    Toast.makeText(PlayActivity.this, "Tes Halaman Terakhir", Toast.LENGTH_SHORT).show();
        ...
        btnPlayArti.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (booleanarti) {
                    pageradapter = new ViewPagerAdapter(PlayActivity.this, artidoa, suarabilal);
                    ...
                    arti = "tidakaktif";
                    booleanarti = false;
                    btnPlayArti.setImageResource(R.drawable.btn_bacaan);
                    ...
                    booleanarti = true;
                    arti = "aktif";
                    btnPlayArti.setImageResource(R.drawable.btn_arti);
                    YoYo.with(Techniques.FlipInX).duration(1000).playOn(viewPager);
                }
